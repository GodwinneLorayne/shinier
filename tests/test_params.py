from shinier.args import Value
...
def test_convert_parameter_kind():
    if hasattr(inspect.Parameter, "POSITIONAL_ONLY"):
        assert convert_parameter_kind(getattr(inspect.Parameter,"POSITIONAL_ONLY")) == ParameterKind.POSITIONAL_ONLY

    if hasattr(inspect.Parameter, "POSITIONAL_OR_KEYWORD"):
        assert convert_parameter_kind(getattr(inspect.Parameter,"POSITIONAL_OR_KEYWORD")) == ParameterKind.POSITIONAL_OR_KEYWORD

    if hasattr(inspect.Parameter, "VAR_POSITIONAL"):
        assert convert_parameter_kind(getattr(inspect.Parameter,"VAR_POSITIONAL")) == ParameterKind.VAR_POSITIONAL

    if hasattr(inspect.Parameter, "KEYWORD_ONLY"):
        assert convert_parameter_kind(getattr(inspect.Parameter,"KEYWORD_ONLY")) == ParameterKind.KEYWORD_ONLY

    if hasattr(inspect.Parameter, "VAR_KEYWORD"):
        assert convert_parameter_kind(getattr(inspect.Parameter,"VAR_KEYWORD")) == ParameterKind.VAR_KEYWORD
