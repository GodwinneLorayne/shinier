...
def test_parse_single_dash_flag():
    assert list(parse_single_dash_flag("-c")) == [Flag(sentinel="-", name="c", full="-c")]
...
def test_parse_double_dash_flag():
    assert list(parse_double_dash_flag("--long")) == [Flag(sentinel="--", name="long", full="--long")]
    ...
    assert list(parse_double_dash_flag("--long=5")) == []
    assert list(parse_double_dash_flag("--multi-word-flag")) == [Flag(sentinel="--", name="multi-word-flag", full="--multi-word-flag")]
    assert list(parse_double_dash_flag("--multi-word-flag=5")) == []
    assert list(parse_double_dash_flag("--mixed_case-flag")) == []
    assert list(parse_double_dash_flag("--snake_case_flag")) == [Flag(sentinel="--", name="snake_case_flag", full="--snake_case_flag")]
    assert list(parse_double_dash_flag("value")) == []

def test_parse_single_dash_assignment():
    assert list(parse_single_dash_assignment("-c=5")) == [Assignment(sentinel="-", name="c", flag="-c", delimiter="=", value="5", full="-c=5")]
    ...
    assert list(parse_single_dash_assignment("-c=")) == [Assignment(sentinel="-", name="c", flag="-c", delimiter="=", value="", full="-c=")]
    assert list(parse_single_dash_assignment("-5=")) == []
    assert list(parse_single_dash_assignment("value")) == []

def test_parse_double_dash_assignment():
    assert list(parse_double_dash_assignment("--long=5")) == [Assignment(sentinel="--", name="long", flag="--long", delimiter="=", value="5", full="--long=5")]
    ...
    assert list(parse_double_dash_assignment("--multi-word-flag=5")) == [Assignment(sentinel="--", name="multi-word-flag", flag="--multi-word-flag", delimiter="=", value="5", full="--multi-word-flag=5")]
...
def test_parse_arguments():
    assert list(parse_arguments(["-c", "--long", "-c=5", "--long=5"])) == [
        ...
        Assignment(sentinel="-", name="c", flag="-c", delimiter="=", value="5", full="-c=5"),
        Assignment(sentinel="--", name="long", flag="--long", delimiter="=", value="5", full="--long=5"),
    ]
    assert list(parse_arguments(["-c", "--long", "-c=5", "--long=5", "--multi-word-flag=5", "--snake_case_flag"])) == [
        Flag(sentinel="-", name="c", full="-c"),
        Flag(sentinel="--", name="long", full="--long"),
        Assignment(sentinel="-", name="c", flag="-c", delimiter="=", value="5", full="-c=5"),
        Assignment(sentinel="--", name="long", flag="--long", delimiter="=", value="5", full="--long=5"),
        Assignment(sentinel="--", name="multi-word-flag", flag="--multi-word-flag", delimiter="=", value="5", full="--multi-word-flag=5"),
        Flag(sentinel="--", name="snake_case_flag", full="--snake_case_flag"),
    ]
    assert list(parse_arguments(["-c", "--long", "-c=5", "--long=5", "--multi-word-flag=5", "--snake_case_flag", "-c=5", "--long=5", "--multi-word-flag=5", "--snake_case_flag"])) == [
        Flag(sentinel="-", name="c", full="-c"),
        Flag(sentinel="--", name="long", full="--long"),
        Assignment(sentinel="-", name="c", flag="-c", delimiter="=", value="5", full="-c=5"),
        Assignment(sentinel="--", name="long", flag="--long", delimiter="=", value="5", full="--long=5"),
    ...
    assert list(parse_arguments(["-c", "--long", "-c=5", "--long=5", "--multi-word-flag=5", "--snake_case_flag", "-c=5", "--long=5", "--multi-word-flag=5", "--snake_case_flag", "value"])) == [
        Flag(sentinel="-", name="c", full="-c"),
        Flag(sentinel="--", name="long", full="--long"),
        Assignment(sentinel="-", name="c", flag="-c", delimiter="=", value="5", full="-c=5"),
        Assignment(sentinel="--", name="long", flag="--long", delimiter="=", value="5", full="--long=5"),
